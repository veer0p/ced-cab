    ...
    <script>
        $(document).ready(function () {
            $('#booking-form').submit(function (e) {
                ...
                $.ajax({
                    url: "./classes/Master.php?f=save_booking",
...
<div id="bg" class="pt-2 pb-2">
    ...
    <section class="container-fluid box col-lg-4 col-sm-10 col-xs-12 col-md-7 ml-lg-5 ml-md-5 pt-lg-4 mt-lg-4 pt-sm-0 mt-sm-0 mb-5 pb-3 pt-2">
      ...
      <div class="form-group  row feilds ">
                ...
                <input type="text" name="pickup" class="form-control-plaintext col-sm-9 arro choose" id="pickup" placeholder="Enter drop off location">
            </div>
        ...
        <div class="form-group  row feilds " style="display: none;">
            ...
            <div class="form-group ">
            <input type="submit" class="btn green btn-primary btn-lg btn-block" id="b" name="book" value="Book Now">
            </div>
        </form>
    </div>
    </section>
